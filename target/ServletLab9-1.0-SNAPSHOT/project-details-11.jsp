<%@ page contentType="text/html;charset=UTF-8" language="java" %>
    <div class="row">
        <div class="col-md-8 project-images">
            <img src="images/portfolio/view/KS3-2.jpg" alt="" class="img-responsive" />
            <img src="images/portfolio/view/KS3-1.jpeg" alt="" class="img-responsive" />
        </div>
        <div class="col-md-4">
            <div class="project-info">
                ...
                <div class="details">
                    <div class="info-text">
                        ...
                        <span class="val">HT 3</span>
                    </div>

                    <div class="info-text">
                        <span class="title">Loại thiết kế</span>
                        <span class="val">Khách sạn</span>
                    </div>
...
<!--                </div>-->
                ...
                <p>
                    ...
                    <ul class="products-design">
                        <li><a href="product-details.jsp">Giường ngủ GN01 </a> </li> Số lượng : 1
                        <li><a href="product-details.jsp">Ghế tựa hồng </a> </li>Số lượng : 4
                        <li><a href="product-details.jsp">Tủ gỗ sim </a> </li>Số lượng : 5
                        <li><a href="product-details.jsp">Sofa GN200 </a> </li>Số lượng : 2
