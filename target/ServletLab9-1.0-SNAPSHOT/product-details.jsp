                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <ul class="crumb">
                            ...
                            <li class="sep">/</li>
                            <li>
                                <a style="color: aliceblue;" href="shop.jsp">Tất cả Sản Phẩm</a></li>

                            <li class="sep">/</li>
                            <li>
                                <a style="color: aliceblue;" href="pngu.jsp">Phòng ngủ</a></li>
                            <li class="sep">/</li>
                            <li>
                                <a style="color: aliceblue;" href="pngu2-tuquanao.jsp">Tủ Quần Áo</a></li>
                            <li class="sep">/</li>
                            <li>
                                <a style="color: aliceblue;" href="product-details.jsp">Tủ quần áo TQA01</a></li>
                            <li class="sep">/</li>
                ...
                <div class="container">
                    <div class="product-detail-left">
                        ...
                        <div class="sp-wrap sp-non-touch" style="display: inline-block;">
                            ...
                            <div class="sp-large">
                                <a href="images/shop/tqa.jpg" class="sp-current-big"><img src="images/shop/tqa.jpg" alt=""></a>
                            </div>
                            <div class="sp-thumbs sp-tb-active">
                                <a href="images/shop/tqa.jpg" style="background-image:url(images/shop/tqa.jpg)" class="sp-current"></a>
                                <a href="images/shop/tqa.jpg" style="background-image:url(images/shop/tqa.jpg)"></a>
                                <a href="images/shop/chitiet3.1.jpg" style="background-image:url(images/shop/chitiet3.1.jpg)"></a>
                            </div>
                        </div>
                    </div>
                    <div class="product-detail-right-1">
                        <h3>Tủ Quần Áo Có Kệ Trang Trí Màu Kem Hiện Đại Đẹp Giá Rẻ <br><small>Mã hàng : GA00006488</small></h3>
                        ...
                        <a href="#" class="writereview"><i class="fas fa-pen"></i>  Viết nhận xét</a>
...
Chất lượng gỗ tốt với khả năng chịu lực, chịu ẩm mốc và mối mọt vượt trội bởi toàn bộ sản phẩm đều được làm từ gỗ MDF chất lượng cao tốt nhất thị trường hiện nay. </div>
                     ...
                     <div style="margin: 0 auto;width: 960px;">
                         <span  onmouseover="starmark(this)" onclick="starmark(this)" id="1one" style="font-size:40px;cursor:pointer;"  class="fa fa-star checked"></span>
                                ...
                                <br/>
                                <textarea style="margin-top:5px;" class="form-control" rows="3" id="comment" placeholder="nhận xét của bạn"></textarea>

                                <button onclick="result()" type="button" style="margin-top:10px;margin-left:5px;" class="btn btn-lg btn-success">gửi</button>
                        ...
                        <footer>
                            <div class="container">
                                <div class="row">
                                    <div class="col-md-4">
                                        <img src="images/logo.png" class="logo-small" alt=""><br> Xin chào! Chắc hẳn AnhEm Clothing còn là một cái tên khá mới đối với nhiều người, sau đây là một số thông tin giúp bạn có thể hiểu rõ hơn về đơn vị của chúng
                                        tôi: AnhEm Clothing được thành lập vào ngày 17-7-2020, cửa hàng được đặt tại thành phố Hồ Chí Minh, với 4 thành viên sáng lập. Đây là đơn vị chuyên cung cấp các mặt hàng thời trang chính hãng có tên tuổi trên toàn
                                        thế giới giúp cho bạn luôn có một phong cách hiện đại, thời thượng và luôn an tâm về chất lượng mà sản phẩm mang lại.
                                    </div>
