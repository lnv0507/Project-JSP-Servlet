<%@ page contentType="text/html;charset=UTF-8" language="java" %>
    <div class="row">
        <div class="col-md-8 project-images">
            <img src="images/portfolio/view/O2-1.jpg" alt="" class="img-responsive" />
            <img src="images/portfolio/view/O2-2.png" alt="" class="img-responsive" />
        </div>
        <div class="col-md-4">
            <div class="project-info">
                ...
                <div class="details">
                    <div class="info-text">
                        ...
                        <span class="val">O 2</span>
                    </div>

                    <div class="info-text">
                        <span class="title">Loại thiết kế</span>
                        <span class="val">Văn phòng</span>
                    </div>
