        ...
        <div id="content" class="no-bottom no-top">
            ...
            <section class="background-login">
                <div class="login-wrap">
                    <div class="login-jsp">
                        <input id="tab-1" type="radio" name="tab" class="sign-in" checked><label for="tab-1" class="tab"><a href="#">Đăng Ký</a></label>
                        <input id="tab-2" type="radio" name="tab" class="sign-up"><label for="tab-2" class="tab"><a href="login.jsp">Đăng Nhập</a></label>
