                        ...
                        <tr>
                            <td style="text-align: center;">
                                <i style="color: #478fca!important;" title="Chi tiết phiếu nhập"
                                   onclick="cms_show_detail_input(35)"
                                   class="fa fa-plus-circle i-detail-input-35">
                                </i>
                                <i style="color: #478fca!important;" title="Chi tiết phiếu nhập"
                                   onclick="cms_show_detail_input(35)"
                                   class="fa fa-minus-circle i-hide i-detail-input-35">
                            ...
                            <td class="text-center">
                                <i class="fa fa-trash-o" style="color: darkred;" title="Xóa"
                                   onclick="cms_del_temp_import(35,1)"></i></td>
                        </tr>
