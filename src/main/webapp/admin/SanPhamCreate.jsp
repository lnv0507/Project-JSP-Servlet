                        ...
                        <div class="row">
                            <div class="form-group clearfix">
                                <div class="col-md-6 padd-left-0">
                                    ...
                                    <input type="text" id="prd_name" value="" class="form-control" placeholder="Nhập tên sản phẩm" name="txtName">
                                </div>
                                <div class="col-md-6 padd-right-0">
                                    <label>Mã sản phẩm</label>
                                    <input type="text" id="prd_code" class="form-control " placeholder="Nếu không nhập, hệ thống sẽ tự sinh." name="txtIDName">
                                </div>
                            </div>
                            <div class="form-group clearfix">
                                <div class="col-md-6 padd-left-0">
                                    <label>Số lượng</label>
                                    <input type="text" id="prd_sls" value="" placeholder="0" class="form-control text-right txtNumber" name="txtNumber">
                                </div>
                                <div class="col-md-6 padd-right-0">
