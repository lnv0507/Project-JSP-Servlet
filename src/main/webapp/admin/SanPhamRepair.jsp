                                        ...
                                        <div class="right-action text-right">
                                            <div class="btn-groups">
                                                ...
                                                <a href="SanPham.jsp">
                                                    ...
                                                    <button type="button" class="btn btn-default" ><i class="fa fa-arrow-left"></i> Hủy
                                                    </button>
                                                </a>
                        ...
                        <div class="row">
                            <div class="form-group clearfix">
                                <div class="col-md-6 padd-left-0">
                                    ...
                                    <input type="text" id="prd_name" value="Áo Jacket JK123123" class="form-control" placeholder="Nhập tên sản phẩm">
                                </div>
                                <div class="col-md-6 padd-right-0">
                                    <label>Mã sản phẩm</label>
                                    <input disabled="disabled" type="text" id="prd_code" class="form-control" value="SP0000012" placeholder="Nếu không nhập, hệ thống sẽ tự sinh.">
                                </div>
                            </div>
                            ...
                            <div class="form-group clearfix">
                                <div class="col-md-6 padd-left-0">
                                    ...
                                    <input type="text" id="prd_sls" value="5" placeholder="0" class="form-control text-right txtNumber">
                                </div>
                                <div class="col-md-6 padd-right-0">
                            ...
                            <div class="form-group clearfix">
                                <div class="col-md-6 padd-left-0">
                                    <label>Giá vốn</label>
                                    <input type="text" id="prd_origin_price" value="100000" class="form-control text-right txtMoney" placeholder="Nhập giá vốn">
                                </div>
                                <div class="col-md-6 padd-right-0">
                                    <label>Giá bán</label>
                                    <input type="text" id="prd_sell_price" value="150000" class="form-control txtMoney text-right" placeholder="0">
                                </div>
                            </div>
                            <div class="form-group clearfix">
                                <div class="col-md-6 padd-left-0">
