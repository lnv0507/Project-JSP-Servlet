                ...
                <div class="sidebar sidebar-fixed hidden-xs hidden-sm hidden-md" id="sidebar">
                    ...
                    <ul class="nav nav-pills nav-list nav-stacked">
                        ...
                        <li id="dashboard"><a href="Trangchu.jsp"
                                              style=" color: white;background-color: #33CB82!important;"
                                              name="btnAction"><i
                                class="fa fa-gg-circle"></i><b>Trang Chủ</b></a></li>
                        <li id="orders"><a href="DonHang.jsp" name="btnAction"><i class="fa fa-shopping-cart"></i><b>Đơn
                            hàng</b></a>
                        </li>
                        <li id="product"><a href="<c:url value="/admin/product"/>" name="btnAction"><i
                                class="fa fa-product-hunt"></i><b>Sản phẩm</b></a>
                        </li>
                        <li id="customer"><a href="<c:url value="/admin/createAcount"/>" name="btnAction"><i
                                class="fa fa-users"></i><b>Khách hàng</b></a></li>
                        <li id="inventory"><a href="TonKho.jsp" name="btnAction"><i class="fa fa-list-alt"></i><b>Tồn
                            kho</b></a></li>
                        <li id="contact"><a href="LienHe.jsp" name="btnAction"><i class="fa fa-user"></i><b>Liên Hệ</b></a>
                        </li>
                        <li id="config"><a href="<c:url value="/admin/admincreate"/> " name="btnAction"><i
                                class="fa fa-empire"></i><b>Thiết lập</b></a></li>
