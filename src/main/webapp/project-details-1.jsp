...
<body id="homepage">
    ...
    <div id="wrapper">
                ...
                <div class="row">
                    <div id="sidebar" class="col-md-3 wow fadeInUp">
                        <ul id="services-list">
                            ...
                            <li class="active"><a href="service-3.jsp">Office Design</a></li>
        ...
        <section id="view-all-projects" class="call-to-action bg-color text-center" data-speed="5" data-type="background">
            <a href="contact.jsp" class="btn btn-line-black btn-big">Get Quotation</a>
        </section>
...
<!-- Mirrored from www.themenesia.com/themeforest/archi-light/service-3.jsp by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 29 Jul 2015 14:09:12 GMT -->
