...
<body id="homepage">
    ...
    <div id="wrapper" style="background-color: #fff;">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <h1>Sản Phẩm</h1>
                        <ul class="crumb">
                            <li class="active wow fadeIn" ><a style="color: aliceblue;"  href="index-2.jsp">Trang Chủ</a></li>
                            <li class="sep">/</li>
                            <li class="wow fadeIn" ><a href="shop.jsp"> Sản Phẩm</a></li>
                            <li class="sep">/</li>
        ...
        <div id="content" class="no-bottom no-top">
                ...
                <div class="row ">
                    <div class="col-md-3 col-sm-6 ">
                        <div class="product-grid ">
                            <a href="pkhach3-ghetua.jsp"> <img src="images/shop/ghetua.jpg " class="img-responsive " alt=" ">
                    ...
                    <div class="col-md-3 col-sm-6 ">
                        <div class="product-grid ">
                            <a href="pkhach4-bankhach.jsp"> <img src="images/shop/bankhach.jpg " class="img-responsive " alt=" ">
                    ...
                    <div class="col-md-3 col-sm-6 ">
                        <div class="product-grid ">
                            <a href="pkhach5-ketivi.jsp"> <img src="images/shop/ketivi.jpg " class="img-responsive " alt=" ">
                    ...
                    <div class="col-md-3 col-sm-6 ">
                        <div class="product-grid ">
                            <a href="pkhach2-giasach.jsp"> <img src="images/shop/giasach.jpg " class="img-responsive " alt=" ">
            ...
            <div class="container ">
                <a href="pngu.jsp" style="text-decoration: none;">
                    <h4 style="text-align: center; font-weight: bolder; ">Nội thất phòng ngủ </h4>
                    <div class="separator" style="margin-top: -12px;"><span><i class="fa fa-circle"></i></span></div>
                </a>
                ...
                <div class="row ">
                    <div class="col-md-3 col-sm-6 ">
                        <div class="product-grid ">
                            <a href="pngu1-giuong.jsp"> <img src="images/shop/giuong.jpg " class="img-responsive " alt=" ">
                    ...
                    <div class="col-md-3 col-sm-6 ">
                        <div class="product-grid ">
                            <a href="pngu2-tuquanao.jsp"> <img src="images/shop/tqa6.jpg " class="img-responsive " alt=" ">
                    ...
                    <div class="col-md-3 col-sm-6 ">
                        <div class="product-grid ">
                            <a href="pngu3-ruongngankeo.jsp"> <img src="images/shop/tudaugiuong01.jpg " class="img-responsive " alt=" ">
                    ...
                    <div class="col-md-3 col-sm-6 ">
                        <div class="product-grid ">
                            <a href="pngu4-bantrangdiem.jsp"> <img src="images/shop/bantrangdiem02.jpg " class="img-responsive " alt=" ">

                                <h5>Bàn trang điểm</h5>
                            </a>
            ...
            <div class="container ">
                ...
                <div class="row ">
                    <div class="col-md-3 col-sm-6 ">
                        <div class="product-grid ">
                            <a href="pbep4-banan.jsp"> <img src="images/shop/banan1.jpg " class="img-responsive " alt=" ">
                    ...
                    <div class="col-md-3 col-sm-6 ">
                        <div class="product-grid ">
                            <a href="pbep5-ghean.jsp"> <img src="images/shop/ghean11.jpg " class="img-responsive " alt=" ">
                    ...
                    <div class="col-md-3 col-sm-6 ">
                        <div class="product-grid ">
                            <a href="pbep2-tubep.jsp"> <img src="images/shop/tubep10.jpg " class="img-responsive " alt=" ">
                    ...
                    <div class="col-md-3 col-sm-6 ">
                        <div class="product-grid ">
                            <a href="pbep3-bodoan.jsp"> <img src="images/shop/bodoan10.jpg " class="img-responsive " alt=" ">
            ...
            <br>
            <div class="container ">
                <a href="ptreem.jsp" style="text-decoration: none;">
                    <h4 style="text-align: center; font-weight: bolder; ">Nội thất trẻ em</h4>
                    <div class="separator" style="margin-top: -12px;"><span><i class="fa fa-circle"></i></span></div>
                </a>
                ...
                <div class="row ">
                    <div class="col-md-3 col-sm-6 ">
                        <div class="product-grid ">
                            <a href="ptreem1-giuong.jsp"> <img src="images/shop/giuongdon.jpg " class="img-responsive " alt=" ">
                    ...
                    <div class="col-md-3 col-sm-6 ">
                        <div class="product-grid ">
                            <a href="ptreem2-giuongtang.jsp"> <img src="images/shop/giuongtang12.jpg " class="img-responsive " alt=" ">
                    ...
                    <div class="col-md-3 col-sm-6 ">
                        <div class="product-grid ">
                            <a href="ptreem3-bnahoc.jsp"> <img src="images/shop/banhoc2.jpg " class="img-responsive " alt=" ">
                    ...
                    <div class="col-md-3 col-sm-6 ">
                        <div class="product-grid ">
                            <a href="ptreem4-keluutru.jsp"> <img src="images/shop/keluutru.jpg " class="img-responsive " alt=" ">
            ...
            <div class="container ">
                <a href="pkhach.jsp" style="text-decoration: none;">
                    <h4 style="text-align: center; font-weight: bolder; ">Đồ trang trí</h4>
                    <div class="separator" style="margin-top: -12px;"><span><i class="fa fa-circle"></i></span></div>
                </a>
                ...
                <div class="row ">
                    <div class="col-md-3 col-sm-6 ">
                        <div class="product-grid ">
                            <a href="trangtri3-tham.jsp"> <img src="images/shop/tham2.jpg " class="img-responsive " alt=" ">
                    ...
                    <div class="col-md-3 col-sm-6 ">
                        <div class="product-grid ">
                            <a href="trangtri1-phukien.jsp"> <img src="images/shop/phukien.jpg " class="img-responsive " alt=" ">
                    ...
                    <div class="col-md-3 col-sm-6 ">
                        <div class="product-grid ">
                            <a href="trangtri2-thapsang.jsp"> <img src="images/shop/thapsang.jpg " class="img-responsive " alt=" ">
                    ...
                    <!-- <div class="col-md-3 col-sm-6 ">
                        <div class="product-grid ">
                            <a href="trangtri2-thapsang.jsp"> <img src="images/shop/thietke1.jpg " class="img-responsive " alt=" ">
                            ...
                            <div class="item ">
                                <div class="product-grid ">
                                    <div class="product-image ">
                                        ...
                                        <span class="product-trend-label ">Tinh Trang Hien Tai</span> <!-- JSP tinh trang-->

                                        <ul class="social ">
                                            <li><a href="cart.jsp " data-tip="Thêm Giỏ Hàng"><i class="fa fa-shopping-cart "></i></a></li>
                                    ...
                                    <div class="product-content ">
                                        <h3 class="title "><a href="product-details.jsp">Name Hinh</a></h3> <!-- Ten cua hinh anh -->
