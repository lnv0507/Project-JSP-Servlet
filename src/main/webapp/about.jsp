        ...
        <div id="content" class="no-bottom no-top">
            ...
            <div id="content" class="no-top no-bottom">
                            ...
                            <div class="col-md-12 container-4">
                                ...
                                <div class="de-team-list">
                                    ...
                                    <div class="team-desc col-md-12">
                                        <h3>Nguyễn Xuân Hương</h3>
                                        <p class="lead">Lập Trình Viên</p>
                                        <div class="small-border"></div>
                                        <p>Hỗ Trợ Team Phần CSS, Hình Ảnh, Word, Sửa Font Web.</p>
                                ...
                                <div class="de-team-list">
                                    ...
                                    <div class="team-desc col-md-12">
                                        ...
                                        <p class="lead">Lập Trình Viên</p>
                                        <div class="small-border"></div>
                                        <p>Leader, Hỗ Trợ Mọi Người, Giao Nhiệm Vụ, Sửa Trang Web, Thêm Những Phần Cần Thiết.</p>
                                        <div class="social">
                                            <a href="#"><i class="fa fa-facebook fa-lg"></i></a>
                                            <a href="#"><i class="fa fa-twitter fa-lg"></i></a>
                                            <a href="#"><i class="fa fa-google-plus fa-lg"></i></a>
                                ...
                                <div class="de-team-list">
                                    ...
                                    <div class="team-desc col-md-12">
                                        <h3>Nguyễn Thị Quí</h3>
                                        <p class="lead">Lập Trình Viên</p>
                                        <div class="small-border"></div>
                                        <p>Làm Trang Sản Phẩm, SQL, Hỗ Trợ Sản Phẩm Cho Web.</p>
                                        <div class="social">
                                            <a href="#"><i class="fa fa-facebook fa-lg"></i></a>
                                            <a href="#"><i class="fa fa-twitter fa-lg"></i></a>
                                            <a href="#"><i class="fa fa-google-plus fa-lg"></i></a>
                ...
                <section id="view-all-projects" class="call-to-action bg-color dark text-center" data-speed="5" data-type="background">
                    <a href="contact.jsp" class="btn btn-line-black btn-big">Liên Hệ Với Chúng Tôi</a>
                </section>
...
<!-- Mirrored from www.themenesia.com/themeforest/archi-light/about.jsp by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 29 Jul 2015 14:09:25 GMT -->
