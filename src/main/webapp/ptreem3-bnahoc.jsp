                    ...
                    <div class="col-md-12 menu_big">
                        ...
                        <nav>
                            <ul id="mainmenu">
                                ...
                                <li><a href="services.jsp">Dịch Vụ</a>
                                    <ul>
                                        <li><a href="service-1.jsp">Residential Design</a></li>
                                        <li><a href="service-2.jsp">Hospitaly Design</a></li>
                                        <li><a href="service-3.jsp">Office Design</a></li>
                                        <li><a href="service-4.jsp">Commercial Design</a></li>
                                    </ul>
                                </li>
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <ul class="crumb">
                            ...
                            <li class="sep">/</li>
                            <li>
                                <a style="color: aliceblue;" href="ptreem.jsp">phòng trẻ em </a>
                            </li>
                            <li class="sep">/</li>
                            <li>
                                <a style="color: aliceblue;" href="ptreem3-bnahoc.jsp"> Bàn học</a>
                            </li>
            ...
            <div class="row ">
                <div class="col-md-3 col-sm-6 ">
                    <div class="product-grid ">
                        <div class="product-image ">
                            <a href="# ">
                                <img class="pic-1 " src="images/shop/giuongdon.jpg ">
                                <img class="pic-2 " src="images/shop/giuongdon.jpg ">
                            </a>
                            ...
                            <ul class="social ">
                                ...
                                <li><a href="product-details.jsp " data-tip="Quick View "><i class="fa fa-search "></i></a></li>
                            </ul>
                        </div>
                ...
                <div class="col-md-3 col-sm-6 ">
                    <div class="product-grid ">
                        <div class="product-image ">
                            <a href="# ">
                                <img class="pic-1 " src="images/shop/giuongdon1.jpg ">
                                <img class="pic-2 " src="images/shop/giuongdon1.jpg ">
                            </a>
                            <!-- <span class="product-trend-label ">Trend</span> -->
                ...
                <div class="col-md-3 col-sm-6 ">
                    <div class="product-grid ">
                        <div class="product-image ">
                            <a href="# ">
                                <img class="pic-1 " src="images/shop/giuongdon3.jpg ">
                                <img class="pic-2 " src="images/shop/giuongdon3.jpg ">
                            </a>
                            <span class="product-trend-label ">Trend</span>
                            <span class="product-discount-label ">-20%</span>
                            <ul class="social ">
                ...
                <div class="col-md-3 col-sm-6 ">
                    <div class="product-grid ">
                        <div class="product-image ">
                            <a href="# ">
                                <img class="pic-1 " src="images/shop/giuongdon4.jpg ">
                                <img class="pic-2 " src="images/shop/giuongdon4.jpg ">
                            </a>
                            <span class="product-trend-label ">Trend</span>
                            <span class="product-discount-label ">-20%</span>
                            <ul class="social ">
                ...
                <div class="col-md-3 col-sm-6 ">
                    <div class="product-grid ">
                        <div class="product-image ">
                            <a href="# ">
                                <img class="pic-1 " src="images/shop/giuongdon22.jpg ">
                                <img class="pic-2 " src="images/shop/giuongdon22.jpg ">
                            </a>
                            <!-- <span class="product-trend-label ">Trend</span> -->
                            <span class="product-discount-label ">-20%</span>
                            <ul class="social ">
                ...
                <div class="col-md-3 col-sm-6 ">
                    <div class="product-grid ">
                        <div class="product-image ">
                            <a href="# ">
                                <img class="pic-1 " src="images/shop/giuongdon15.jpg ">
                                <img class="pic-2 " src="images/shop/giuongdon15.jpg ">
                            </a>
                            <span class="product-trend-label ">Trend</span>
                            <span class="product-discount-label ">-20%</span>
                            <ul class="social ">
                ...
                <div class="col-md-3 col-sm-6 ">
                    <div class="product-grid ">
                        <div class="product-image ">
                            <a href="# ">
                                <img class="pic-1 " src="images/shop/giuongdon6.jpg ">
                                <img class="pic-2 " src="images/shop/giuongdon6.jpg ">
                            </a>
                            <span class="product-trend-label ">Trend</span>
                            <span class="product-discount-label ">-20%</span>
                            <ul class="social ">
                ...
                <div class="col-md-3 col-sm-6 ">
                    <div class="product-grid ">
                        <div class="product-image ">
                            <a href="# ">
                                <img class="pic-1 " src="images/shop/giuongdon7.jpg ">
                                <img class="pic-2 " src="images/shop/giuongdon7.jpg ">
                            </a>
                            <span class="product-trend-label ">Trend</span>
                            <span class="product-discount-label ">-20%</span>
                            <ul class="social ">
                ...
                <div class="col-md-3 col-sm-6 ">
                    <div class="product-grid ">
                        <div class="product-image ">
                            <a href="# ">
                                <img class="pic-1 " src="images/shop/giuongdon8.jpg ">
                                <img class="pic-2 " src="images/shop/giuongdon8.jpg ">
                            </a>
                            <!-- <span class="product-trend-label ">Trend</span> -->
                            <span class="product-discount-label ">-20%</span>
                            <ul class="social ">
                ...
                <div class="col-md-3 col-sm-6 ">
                    <div class="product-grid ">
                        <div class="product-image ">
                            <a href="# ">
                                <img class="pic-1 " src="images/shop/giuongdon9.jpg ">
                                <img class="pic-2 " src="images/shop/giuongdon9.jpg ">
                            </a>
                            <span class="product-trend-label ">Trend</span>
                            <span class="product-discount-label ">-20%</span>
                            <ul class="social ">
                ...
                <div class="col-md-3 col-sm-6 ">
                    <div class="product-grid ">
                        <div class="product-image ">
                            <a href="# ">
                                <img class="pic-1 " src="images/shop/giuongdon10.jpg ">
                                <img class="pic-2 " src="images/shop/giuongdon10.jpg ">
                            </a>
                            <span class="product-trend-label ">Trend</span>
                            <span class="product-discount-label ">-20%</span>
                            <ul class="social ">
                ...
                <div class="col-md-3 col-sm-6 ">
                    <div class="product-grid ">
                        <div class="product-image ">
                            <a href="# ">
                                <img class="pic-1 " src="images/shop/giuongdon11.jpg ">
                                <img class="pic-2 " src="images/shop/giuongdon11.jpg ">
                            </a>
                            <span class="product-trend-label ">Trend</span>
                            <span class="product-discount-label ">-20%</span>
                            <ul class="social ">
                ...
                <div class="col-md-3 col-sm-6 ">
                    <div class="product-grid ">
                        <div class="product-image ">
                            <a href="# ">
                                <img class="pic-1 " src="images/shop/giuongdon12.jpg ">
                                <img class="pic-2 " src="images/shop/giuongdon12.jpg ">
                            </a>
                ...
                <div class="col-md-3 col-sm-6 ">
                    <div class="product-grid ">
                        <div class="product-image ">
                            <a href="# ">
                                <img class="pic-1 " src="images/shop/giuongdon13.jpg ">
                                <img class="pic-2 " src="images/shop/giuongdon13.jpg ">
                            </a>
                            <span class="product-trend-label ">Mới</span>
                ...
                <div class="col-md-3 col-sm-6 ">
                    <div class="product-grid ">
                        <div class="product-image ">
                            <a href="# ">
                                <img class="pic-1 " src="images/shop/giuongdon14.jpg ">
                                <img class="pic-2 " src="images/shop/giuongdon14
                                .jpg ">
                            </a>
                            <!-- <span class="product-trend-label ">Mới</span> -->
                ...
                <div class="col-md-3 col-sm-6 ">
                    <div class="product-grid ">
                        <div class="product-image ">
                            <a href="# ">
                                <img class="pic-1 " src="images/shop/giuongdon16.jpg ">
                                <img class="pic-2 " src="images/shop/giuongdon16.jpg ">
                            </a>
                            <span class="product-trend-label ">Trend</span>
                            <ul class="social ">
                                <li><a href="cart.jsp " data-tip="Add to Cart "><i class="fa fa-shopping-cart "></i></a></li>
                ...
                <div class="col-md-3 col-sm-6 ">
                    <div class="product-grid ">
                        <div class="product-image ">
                            <a href="# ">
                                <img class="pic-1 " src="images/shop/giuongdon17.jpg ">
                                <img class="pic-2 " src="images/shop/giuongdon17.jpg ">
                            </a>
                            <!-- <span class="product-trend-label ">Trend</span> -->
                            <span class="product-discount-label ">-20%</span>
                            <ul class="social ">
                ...
                <div class="col-md-3 col-sm-6 ">
                    <div class="product-grid ">
                        <div class="product-image ">
                            <a href="# ">
                                <img class="pic-1 " src="images/shop/giuongdon18.jpg ">
                                <img class="pic-2 " src="images/shop/giuongdon18.jpg ">
                            </a>
                            <span class="product-trend-label ">Trend</span>
                            <span class="product-discount-label ">-20%</span>
                            <ul class="social ">
                ...
                <div class="col-md-3 col-sm-6 ">
                    <div class="product-grid ">
                        <div class="product-image ">
                            <a href="# ">
                                <img class="pic-1 " src="images/shop/giuongdon19.jpg ">
                                <img class="pic-2 " src="images/shop/giuongdon19.jpg ">
                            </a>
                            <span class="product-trend-label ">Trend</span>
                            <span class="product-discount-label ">-20%</span>
                            <ul class="social ">
                ...
                <div class="col-md-3 col-sm-6 ">
                    <div class="product-grid ">
                        <div class="product-image ">
                            <a href="# ">
                                <img class="pic-1 " src="images/shop/giuongdon20.jpg ">
                                <img class="pic-2 " src="images/shop/giuongdon20.jpg ">
                            </a>
                            <!-- <span class="product-trend-label ">Trend</span> -->
                            <span class="product-discount-label ">-20%</span>
                            <ul class="social ">
                ...
                <div class="col-md-3 col-sm-6 ">
                    <div class="product-grid ">
                        <div class="product-image ">
                            <a href="# ">
                                <img class="pic-1 " src="images/shop/giuongdon21.jpg ">
                                <img class="pic-2 " src="images/shop/giuongdon21.jpg ">
                            </a>
                            <span class="product-trend-label ">Trend</span>
                            <span class="product-discount-label ">-20%</span>
                            <ul class="social ">
                ...
                <div class="col-md-3 col-sm-6 ">
                    <div class="product-grid ">
                        <div class="product-image ">
                            <a href="# ">
                                <img class="pic-1 " src="images/shop/giuongdon23.jpg ">
                                <img class="pic-2 " src="images/shop/giuongdon23
                                .jpg ">
                            </a>
                            <span class="product-trend-label ">Trend</span>
                            <span class="product-discount-label ">-20%</span>
                ...
                <div class="otherInfoBody ">
                    ...
                    <div class="col-md-3 col-sm-6 ">
                        <div class="product-grid ">
                            <div class="product-image ">
                                <a href="# ">
                                    <img class="pic-1 " src="images/shop/giuongdon25.jpg ">
                                    <img class="pic-2 " src="images/shop/giuongdon25.jpg ">
                                </a>
                                <span class="product-trend-label ">Trend</span>
                                <span class="product-discount-label ">-20%</span>
                                <ul class="social ">
                    ...
                    <div class="col-md-3 col-sm-6 ">
                        <div class="product-grid ">
                            <div class="product-image ">
                                <a href="# ">
                                    <img class="pic-1 " src="images/shop/giuongdon26.jpg ">
                                    <img class="pic-2 " src="images/shop/giuongdon26.jpg ">
                                </a>
                                <span class="product-trend-label ">Trend</span>
                                <span class="product-discount-label ">-20%</span>
                                <ul class="social ">
                    ...
                    <div class="col-md-3 col-sm-6 ">
                        <div class="product-grid ">
                            <div class="product-image ">
                                <a href="# ">
                                    <img class="pic-1 " src="images/shop/giuongdon24.jpg ">
                                    <img class="pic-2 " src="images/shop/giuongdon24.jpg ">
                                </a>
                                <!-- <span class="product-trend-label ">Mới</span> -->
        ...
        <!-- <div class="row " style="margin: 0px;">
            ...
            <ul class="products " style="text-align: left ;height: 270px;">
                <li class="col-md-2 product ">
                    ...
                    <img src="images/shop/thietke.jpg " class="img-responsive " alt=" ">
                    <h5>Giường nền</h5>
                ...
                <li class="col-md-2 product ">
                    <img src="images/shop/thietke1.jpg " class="img-responsive " alt=" ">
                ...
                <li class="col-md-2 product ">
                    <img src="images/shop/thietke2.jpg " class="img-responsive " alt=" ">
                ...
                <li class="col-md-2 product ">
                    ...
                    <img src="images/shop/thietke3.jpg " class="img-responsive " alt=" ">
                    <h5>Giường đa năng</h5>

                </li>

                <li class="col-md-2 product ">
                    <img src="images/shop/thietke4.jpg " class="img-responsive " alt=" ">
                    <h5>Giường tầng</h5>
                ...
                <li class="col-md-2 product ">
                    <img src="images/shop/thietke5.jpg " class="img-responsive " alt=" ">
        ...
        <div class="phobien">
            ...
            <div class="carousel" data-flickity='{ "wrapAround": true, "autoPlay": true }'>
                <div class="carousel-cell">
                    <img class="w3-image" src="images/shop/giuongdon.jpg">
                </div>
                <div class="carousel-cell">
                    <img class="w3-image" src="images/shop/giuongdon1.jpg">
                </div>
                <div class="carousel-cell">
                    <img class="w3-image" src="images/shop/giuongdon3.jpg">
                </div>
                <div class="carousel-cell">
                    <img class="w3-image" src="images/shop/giuongdon.jpg5">
                </div>
                <div class="carousel-cell">
                    <img class="w3-image" src="images/shop/giuongdon7.jpg">
                </div>
                <div class="carousel-cell">
                    <img class="w3-image" src="images/shop/giuongdon11.jpg">
                </div>
                <div class="carousel-cell">
                    <img class="w3-image" src="images/shop/giuongdon12.jpg">
                </div>
                <div class="carousel-cell">
                    <img class="w3-image" src="images/shop/giuongdon13.jpg">
                </div>
                <div class="carousel-cell">
                    <img class="w3-image" src="images/shop/giuongdon15.jpg">
                </div>
                <div class="carousel-cell">
                    <img class="w3-image" src="images/shop/giuongdon23.jpg">
                </div>
                <div class="carousel-cell">
                    <img class="w3-image" src="images/shop/giuongdon26.jpg">
                </div>
