                ...
                <div class="process-wrapper">
                    <div id="progress-bar-container">
                        <ul>
                            <li class="step step01 active">
                                <div class="step-inner">Người mua đặt hàng</div>
                            </li>
                            <li class="step step02">
                                <div class="step-inner">Xác nhận đơn hàng</div>
                            </li>
                            <li class="step step03">
                                <div class="step-inner">Đang chuyển hàng</div>
                            </li>
                            <li class="step step04">
                                <div class="step-inner">Chờ nhận hàng</div>
                            </li>
                            <li class="step step05">
                                <div class="step-inner">Đã giao hàng</div>
                            </li>
                        </ul>
                    ...
                    <div id="progress-content-section">
                        <div class="section-content discovery active">
                            <h2>Người mua đặt hàng</h2>
                            <p>Người mua đã đặt đơn hàng có mã đơn hàng số #5646 lúc 15:40p ngày 23/10/2020. Xin hãy vui lòng đợi cửa hàng xác nhận đơn đặt hàng.</p>

                        </div>

                        <div class="section-content strategy">
                            <h2>Xác nhận đơn hàng</h2>
                            <p>Cửa hàng đã xác nhận đơn hàng có mã #5646 lúc 14h:00p ngày 24/10/2020. Hàng của bạn đang trong quá trình nhập hàng và chuẩn bị vận chuyển. </p>
                        </div>

                        <div class="section-content creative">
                            <h2>Chuyển hàng</h2>
                            <p>Đơn hàng của bạn đã được chuyển đi lúc 7h:30p ngày 25/10/2020 và đang trong quá trình vận chuyển.</p>
                        </div>

                        <div class="section-content production">
                            <h2>Nhận hàng</h2>
                            <p>Đơn hàng của bạn đã được chuyển đến lúc 9h:00p ngày 29/10/2020, xin mời bạn nhận hàng.</p>
                        </div>

                        <div class="section-content analysis">
                            <h2>Đã giao hàng</h2>
                            <p>Đơn hàng đã được giao hoàn tất lúc 15h:00p ngày 29/10/2020. Cảm ơn bạn đã mua hàng của cửa hàng.</p>
                        </div>
                    </div>
                </div>
