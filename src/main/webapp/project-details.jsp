                    ...
                    <div class="container">
                        ...
                        <div id="gallery" class="gallery full-gallery de-gallery pf_full_width wow fadeInUp" data-wow-delay=".3s">
                            ...
                            <div class="item residential">
                                <div class="picframe">
                                    <a class="simple-ajax-popup-align-top" href="project-h-1.jsp">
                                        <span class="overlay">
                                    <span class="pf_text">
                            ...
                            <div class="item hospitaly">
                                <div class="picframe">
                                    <a class="simple-ajax-popup-align-top" href="project-details-3.jsp">
                                        <span class="overlay">
                                    <span class="pf_text">
                            ...
                            <div class="item residential">
                                <div class="picframe">
                                    <a class="simple-ajax-popup-align-top" href="project-details-youtube.jsp">
                                        <span class="overlay">
                                    <span class="pf_text">
                            ...
                            <div class="item office">
                                <div class="picframe">
                                    <a class="simple-ajax-popup-align-top" href="project-details-vimeo.jsp">
                                        <span class="overlay">
                                    <span class="pf_text">
