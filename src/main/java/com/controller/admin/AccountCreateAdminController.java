...
@WebServlet(urlPatterns = "/admin/createAcount")
public class AccountCreateAdminController extends HttpServlet {
    private final static String SUCCESS = "KhachHang.jsp";
    private final static String ERROR = "Trangchu.jsp";
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            ...
            if (check) {
                AccountDTO accDTO = new AccountDTO(idAccount, nameAccount, soDienThoai, diachi, email, "Khách Hàng", pass);
